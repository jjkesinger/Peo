...
public class HourlyWageCalculatorTests
{
    ...
    public async Task CalculateAsync_GivenHourlyEmployeeWithChangeInPayHistory_ShouldCalculatesTotalWages()
    {
            ...
            .WithEmployee(new EmployeeBuilder()
                .WithEmployeePayHistory([
                    new EmployeePayBuilder()
                        .WithEffectiveDate(new DateTime(2018, 1, 1, 0, 0, 0, DateTimeKind.Local))
                        .WithUpdateDate(new DateTime(2018, 1, 1, 0, 0, 0, DateTimeKind.Local))
                        .WithTermDate(new DateTime(2024, 12, 13, 0, 0, 0, DateTimeKind.Local))
                        .WithPaymentAmount(50m)
                        .WithWageType(WageType.Hourly)
                        .Build(),
                    new EmployeePayBuilder()
                        .WithEffectiveDate(new DateTime(2024, 12, 13, 0, 0, 0, DateTimeKind.Local))
                        .WithUpdateDate(new DateTime(2024, 12, 13, 0, 0, 0, DateTimeKind.Local))
                        .WithPaymentAmount(55m)
                        .WithWageType(WageType.Hourly)
                        .Build()
                    ])
                .WithEmployeeHireHistory([
        ...
        Assert.AreEqual(4200m, val.Sum(f => f.Amount));
    }
    ...
    public async Task CalculateAsync_GivenHourlyEmployeeWithChangeInPayHistoryDuringTimePeriod_ShouldCalculatesTotalWages()
    {
            ...
            .WithEmployee(new EmployeeBuilder()
                .WithEmployeePayHistory([
                    new EmployeePayBuilder()
                        .WithEffectiveDate(new DateTime(2018, 1, 1, 0, 0, 0, DateTimeKind.Local))
                        .WithUpdateDate(new DateTime(2018, 1, 1, 0, 0, 0, DateTimeKind.Local))
                        .WithTermDate(new DateTime(2024, 12, 15, 3, 59, 59, 999, DateTimeKind.Local))
                        .WithPaymentAmount(50m)
                        .WithWageType(WageType.Hourly)
                        .Build(),
                    new EmployeePayBuilder()
                        .WithEffectiveDate(new DateTime(2024, 12, 15, 4, 0, 0, DateTimeKind.Local))
                        .WithUpdateDate(new DateTime(2024, 12, 15, 4, 0, 0, DateTimeKind.Local))
                        .WithPaymentAmount(55m)
                        .WithWageType(WageType.Hourly)
                        .Build()
                    ])
        ...
        Assert.AreEqual(4180m, val.Sum(f => f.Amount));
    }
}
