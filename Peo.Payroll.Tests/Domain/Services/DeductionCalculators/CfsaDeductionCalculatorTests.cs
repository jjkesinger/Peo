...
[TestClass]
public class CfsaDeductionCalculatorTests
{
    ...
    private readonly CfsaDeductionCalculator Target;

    public CfsaDeductionCalculatorTests()
    {
        Target = new CfsaDeductionCalculator(_employeeElectionLookupService, _employeeContributionLookupService);
    }
    ...
    public async Task CalculateAsync_GivenEmployeeEnrolled_ShouldCalculateAmount()
    {
        ...
        A.CallTo(() => _employeeElectionLookupService
            ...
            .Returns([new EmployeeElectionBuilder().WithElectionType(ElectionType.Cfsa).Build()]);
        ...
        A.CallTo(() => _employeeContributionLookupService
            ...
            .Returns([new EmployeeContributionBuilder()
                ...
                .WithRate(.2m)
                .WithElectionType(ElectionType.Cfsa)
                .Build()]
            );
